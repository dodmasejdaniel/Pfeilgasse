...
import dryerMachine from "../../../assets/dryer.avif"
    ...
    return (
        <Page>
            ...
            <div className='w-full flex flex-col-reverse md:flex-row md:max-w-6xl gap-10 justify-center'>
                <BookingOption imageSrc={dryerMachine.src} title='Dryer' />
                <form onSubmit={onSubmit} className='px-10 md:px-0 flex flex-col gap-4'>
                    <CustomSelect options={[
                        { value: "1", label: "Dryer Machine 1" },
                        { value: "2", label: "Dryer Machine 2" },
                        { value: "3", label: "Dryer Machine 3" },
                    ]} selectProps={register("dryer")} />
                    <div>
